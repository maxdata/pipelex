...
import pytest
import tomlkit
from tomlkit import array, inline_table, table
from pytest_mock import MockerFixture

from pipelex import log, pretty_print
from pipelex.core.bundles.pipelex_bundle_blueprint import PipelexBundleBlueprint
from pipelex.language.plx_config import PlxConfig, PlxConfigStrings, PlxConfigInlineTables, PlxConfigForConcepts, PlxConfigForPipes
from pipelex.language.plx_factory import PlxFactory, SectionKey
...
class TestPlxFactoryUnit:
    ...
    def test_make_table_obj_for_concept_simple_string(self, mocker: MockerFixture, mock_plx_config: PlxConfig):
        ...
        concept_data = {
            "SimpleConcept": "A simple concept definition"
        }
